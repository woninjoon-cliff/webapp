...
var PROC_시술구분목록 = ['일반', '회원권', '체험단/무료', '다회차'];
...
// {
//   금일건수, 당월건수, 당월매출,
//   당월구분별: { 일반: n, 회원권: n, '체험단/무료': n, 다회차: n },
...
function PROC_getSummary(token) {
  ...
  var 결과 = {
    ...
    당월구분별: { 일반: 0, 회원권: 0, '체험단/무료': 0, 다회차: 0 },
    당월구분별매출: { 일반: 0, 회원권: 0, '체험단/무료': 0, 다회차: 0 },
    원가연결: false
  };
...
// 일괄 저장 (시술 등록)
//
// 공통: { 시술일: 'yyyy-MM-dd', 시술구분: '일반'|'회원권'|'체험단/무료'|'다회차' }
// 행목록: [
